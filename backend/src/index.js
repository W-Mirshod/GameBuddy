...
import { registerTournamentRulesScheduler } from './jobs/tournamentRules.job.js';
...
registerTournamentRulesScheduler().catch((e) => console.log('[tournamentRules] scheduler error', e));
